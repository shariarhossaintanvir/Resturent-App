  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400 mt-1">
            Real-time telemetry across Dhaka partner kitchens, delivery riders and customer demand
          </p>
        </div>
        ...
        <div className="flex items-center gap-2">
          <Link
            href="/admin/orders"
            className="px-3.5 py-2 rounded-xl bg-primary-500 hover:bg-primary-600 text-white text-xs font-bold shadow-md shadow-primary-500/20 transition-all flex items-center gap-1.5"
          >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
        {/* Total Orders */}
        <div className="bg-white dark:bg-slate-900 p-5 rounded-2xl border border-slate-200/80 dark:border-slate-800 shadow-card space-y-2">
          <div className="flex items-center justify-between text-slate-400">
            <span className="text-[11px] font-bold uppercase tracking-wider">Total Orders</span>
            <div className="w-7 h-7 rounded-lg bg-blue-50 dark:bg-blue-950/50 text-blue-500 flex items-center justify-center">
        ...
        <div className="bg-white dark:bg-slate-900 p-5 rounded-2xl border border-slate-200/80 dark:border-slate-800 shadow-card space-y-2">
          <div className="flex items-center justify-between text-slate-400">
            ...
            <div className="w-7 h-7 rounded-lg bg-emerald-50 dark:bg-emerald-950/50 text-emerald-500 flex items-center justify-center">
        ...
        <div className="bg-white dark:bg-slate-900 p-5 rounded-2xl border border-slate-200/80 dark:border-slate-800 shadow-card space-y-2">
          <div className="flex items-center justify-between text-slate-400">
            ...
            <div className="w-7 h-7 rounded-lg bg-orange-50 dark:bg-orange-950/50 text-primary-500 flex items-center justify-center">
        ...
        <div className="bg-white dark:bg-slate-900 p-5 rounded-2xl border border-slate-200/80 dark:border-slate-800 shadow-card space-y-2">
          <div className="flex items-center justify-between text-slate-400">
            ...
            <div className="w-7 h-7 rounded-lg bg-purple-50 dark:bg-purple-950/50 text-purple-500 flex items-center justify-center">
          ...
          <span className="text-[11px] text-emerald-600 font-semibold">Priority tables booked</span>
        </div>

        {/* Restaurants / Customers */}
        <div className="bg-white dark:bg-slate-900 p-5 rounded-2xl border border-slate-200/80 dark:border-slate-800 shadow-card space-y-2 col-span-2 sm:col-span-1">
          <div className="flex items-center justify-between text-slate-400">
            <span className="text-[11px] font-bold uppercase tracking-wider">Partner Kitchens</span>
            <div className="w-7 h-7 rounded-lg bg-amber-50 dark:bg-amber-950/50 text-amber-500 flex items-center justify-center">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h3 className="font-bold text-sm text-slate-900 dark:text-white uppercase tracking-wider">
              Today&apos;s Order Velocity (Dhaka Zones)
            </h3>
            <p className="text-xs text-slate-400">Live order volume distribution across peak hours</p>
          </div>
          <span className="text-xs font-bold text-emerald-500 bg-emerald-50 dark:bg-emerald-950/50 px-2.5 py-1 rounded-lg border border-emerald-500/20">
            Peak: 7 PM - 10 PM
          </span>
        </div>
        ...
        <div className="pt-4 flex items-end justify-between gap-2 h-44">
          {[
            ...
            <div key={bar.hour} className="flex-1 flex flex-col items-center gap-2 group h-full justify-end">
              ...
              <div
                className="w-full rounded-xl bg-gradient-to-t from-primary-600 to-amber-400 group-hover:brightness-110 transition-all cursor-pointer shadow-sm"
      ...
      <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200/80 dark:border-slate-800 shadow-card overflow-hidden">
        <div className="p-5 sm:p-6 flex items-center justify-between border-b border-slate-100 dark:border-slate-800">
          <div>
            ...
            <p className="text-xs text-slate-400 mt-0.5">Live incoming customer orders</p>
          </div>
          <Link
            href="/admin/orders"
